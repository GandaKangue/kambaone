...
if ( ! class_exists( 'Kamba_One_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Kamba-One 1.0.0
	 */
	class Kamba_One_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'kambaone' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'kambaone' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'kambaone' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'kambaone' ),
						'full'    => esc_html__( 'Full text', 'kambaone' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-kamba-one-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'Kamba_One_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new Kamba_One_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'kambaone' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
